...
//		double[] d1 = {1,2,2,2,2,2};
//		double[] d2 = {2,1,2,2,2,2};
//		double[] d3 = {2,2,1,2,2,20};
//		double[] c = {2,3};
//		
//		List<Vector> vecList = new ArrayList<Vector>();
...
//		System.out.println(Vector.span(vecList, 6));
		
		double[] d1 = {1.0,2.0,2.0,3.0};
		double[] d2 = {2.0,4.0,5.0,2.0};
		double[] d3 = {5.0,8.0,10.0,7.0};
		double[] d4 = {7.0,16.0,14.0,2.0};
		double[] c = {14.0, 30.0, 31.0, 14.0};
		
		List<Vector> v = new ArrayList<Vector>();
		v.add(new Vector(d1, d1.length));
		v.add(new Vector(d2, d2.length));
		v.add(new Vector(d3, d3.length));
		v.add(new Vector(d4, d4.length));
		
		Vector ans = Vector.Gauss_Jordan(v, 4, new Vector(c,c.length));
		System.out.println("\n\n");
		ans.printElements();
